...
public class Claw {
	...
	/**
	 * Moves the left claw with a given value from -1 to 1. Pre: None Post: The
	 * speed of the left claw is set to a given value
	 *
	 * @param value
	 *            the speed of the left claw to set
	 */
	...
	/**
	 * Moves the right claw with a given value from -1 to 1 Pre: None Post: The
	 * speed of the right claw is set to a given value
	 *
	 * @param value
	 *            the speed of the left claw to set
	 */
